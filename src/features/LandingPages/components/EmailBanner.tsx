import { Button, Image, Text, TextInput, Title, createStyles, rem } from '@mantine/core'
...
export function EmailBanner() {
	...
	return (
		<div className={classes.wrapper}>
			...
			<Image src={'/images/emailBanner.svg'} className={classes.image} alt='Newsletter Email Banner Image' />
		</div>
	)
}
